...
module.exports = {
  ...
  seats: [
    ...
    { kind: 'emp', id: 'U3', name: '侯美', unit: '工務部', title: '',     empNo: 'A03', table: '1', veg: true,  changed: true  },
    { kind: 'emp', id: 'U4', name: '余華', unit: '工務部', title: '',     empNo: 'A04', table: '2', veg: false, changed: false },
    { kind: 'emp', id: 'U5', name: '史安', unit: '工務部', title: '',     empNo: 'A05', table: '',  veg: true,  changed: false },
    ...
    { kind: 'guest', id: '4', name: '元小仁',     unit: '乙二', title: '', empNo: '', note: '', table: '2', veg: false, changed: false },
  ],
};
